...
<head>
    ...
    <link rel="stylesheet" href="/InicioWeb/style1.css">
        ...
        <div class="area-formulario">
            <div class="formulario">
                    <div class="botoes">
                       ...
                       <a href="./alunos inscritos/index.php"> <button class="btn" id="sla"> <img src="./assets/icon2.svg" alt="" height="139px"> <br> GERAR RELATÓRIO</button></a>
